...
const TermsAndConditions = () => {
  //TermsAndConditions.navigationOptions = (navData) => {
    ...
    <View style={styles.container}>
      ...
      >
        <Text style={styles.tcP}>
          Welcome to VVAT website. If you continue to browse and use this
          ...
          govern vvat’s relationship with you in relation to this website. If
          you disagree with any part of these terms and conditions, please do
          not use our website.
        </Text>
        <Text style={styles.tcP}>
          The term ‘vvat’ or ‘us’ or ‘we’ refers to the owner of the website
          whose registered office is in beer-sheva,israel. Our company
          registration number is +972-2222-2222. The term ‘you’ refers to the
        ...
        <Text style={styles.tcL}>
          ...
          may be stored by us for use by third parties: email,name,friends etc.
        </Text>
        <Text style={styles.tcL}>
